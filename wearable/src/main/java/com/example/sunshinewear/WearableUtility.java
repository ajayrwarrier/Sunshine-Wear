...
/**
 * Created by Ajay R Warrier on 26-12-2016.
 */
public class WearableUtility {
    private static final String TAG = "WearableUtility";
                ...
                new ResultCallback<NodeApi.GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(WearableUtility.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        WearableUtility.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        WearableUtility.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
    ...
    public static int getIconResource(int weatherId) {
